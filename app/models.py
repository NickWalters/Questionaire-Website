...
db.session.add(QuestionChoice(question_id=13,choice_number=4,choice_content="Norwegian",choice_correct=True))
...
db.session.add(QuestionChoice(question_id=20,choice_number=2,choice_content="Indonesian",choice_correct=True))
